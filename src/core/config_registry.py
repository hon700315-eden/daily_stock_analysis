...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "DEFAULT_MARKET": {
        ...
        "description": "Formal default market for routing and UI defaults. Taiwan mode uses tw.",
        "category": "system",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "validation": {"enum": ["tw"]},
        "display_order": 47,
        "help_key": "settings.system.market_defaults",
        "examples": ["DEFAULT_MARKET=tw"],
        "docs": [
            {"label": "Taiwan Daily Data Bridge", "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/TAIWAN_DAILY_DATA_BRIDGE.md"}
        ],
        "warning_codes": [],
    },
    "DEFAULT_LANGUAGE": {
        "title": "Default Language",
        "description": "Default user-facing language for Taiwan market mode.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "display_order": 47,
        "help_key": "settings.system.market_defaults",
        "examples": ["DEFAULT_LANGUAGE=zh-TW"],
        "docs": [
            {"label": "Taiwan Daily Data Bridge", "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/TAIWAN_DAILY_DATA_BRIDGE.md"}
        ],
        "warning_codes": [],
    ...
    "DEFAULT_CURRENCY": {
        ...
        "description": "Default currency for Taiwan market mode.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "DEFAULT_TIMEZONE": {
        ...
        "description": "Default timezone for Taiwan market mode.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "display_order": 47,
        "help_key": "settings.system.market_defaults",
        "examples": ["DEFAULT_TIMEZONE=Asia/Taipei"],
        "docs": [
            {"label": "Taiwan Daily Data Bridge", "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/TAIWAN_DAILY_DATA_BRIDGE.md"}
        ],
        "warning_codes": [],
    },
    "DEFAULT_PRICE_COLOR_SCHEME": {
        "title": "Default Price Color Scheme",
        "description": "Default price color convention for Taiwan market mode.",
        "category": "system",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "validation": {"enum": ["red_up", "green_up"]},
        "display_order": 47,
        "help_key": "settings.system.market_defaults",
        "examples": ["DEFAULT_PRICE_COLOR_SCHEME=red_up"],
        "docs": [
            {"label": "Taiwan Daily Data Bridge", "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/TAIWAN_DAILY_DATA_BRIDGE.md"}
        ],
        "warning_codes": [],
    },
    "DEFAULT_LISTED_SUFFIX": {
        "title": "Default Listed Suffix",
        "description": "Taiwan listed stock suffix.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "display_order": 47,
        "help_key": "settings.system.market_defaults",
        "examples": ["DEFAULT_LISTED_SUFFIX=.TW"],
        "docs": [
            {"label": "Taiwan Daily Data Bridge", "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/TAIWAN_DAILY_DATA_BRIDGE.md"}
        ],
        "warning_codes": [],
    ...
    "DEFAULT_OTC_SUFFIX": {
        "title": "Default OTC Suffix",
        "description": "Taiwan OTC stock suffix.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "display_order": 47,
        "help_key": "settings.system.market_defaults",
        "examples": ["DEFAULT_OTC_SUFFIX=.TWO"],
        "docs": [
            {"label": "Taiwan Daily Data Bridge", "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/TAIWAN_DAILY_DATA_BRIDGE.md"}
        ],
        "warning_codes": [],
    },
    "DEFAULT_PRIMARY_INDICES": {
        "title": "Default Primary Indices",
        "description": "Comma-separated Taiwan primary index labels.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "加權指數,櫃買指數",
        "options": [],
        "validation": {},
        "display_order": 47,
        "help_key": "settings.system.market_defaults",
        "examples": ["DEFAULT_PRIMARY_INDICES=加權指數,櫃買指數"],
        "docs": [
            {"label": "Taiwan Daily Data Bridge", "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/TAIWAN_DAILY_DATA_BRIDGE.md"}
        ],
        "warning_codes": [],
